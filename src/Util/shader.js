...
var lifeShader_noise = {
    vertexShader: 
        ...
        uniform float time;
        uniform float noiseCount; // 10. ~ 100.
        uniform float noiseGap; // 5. ~ 50.
        ...
        void main() {
            ...
            noise = noiseCount *  -.10 * turbulence( .5 * normal + time );
            float b = noiseGap * pnoise( 0.05 * position + vec3( 2.0 * time ), vec3( 100.0 ) );
