class Slider {
    ...
    elementDrag(e) {
        ...
        let constrainedOffset = constrain(offset, this.sliderBoundary.top, window.inner - this.sliderRect.height)
    ...
    adjustSize(metaDataLength) {
        ...
        if (vhToPx(metaDataLength) > this.sliderBoundary.bottom  && this.sliderRect.height>10) {
            this.sliderElement.style.height = pxToVh((this.sliderBoundary.height - (metaDataLength-this.overflowLength))) + "vh"
        }
        else{
